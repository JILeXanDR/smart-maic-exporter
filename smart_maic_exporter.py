...
metrics = {
    ...
    # Counters
    "energy": Counter(f"{metric_prefix}energy", "Energy (Wh)", ["line"], registry=registry),
    "total_energy": Counter(f"{metric_prefix}total_energy", "Total Energy (Wh)", registry=registry),
}
